...
def predict_occupancy_logic(df, window_size=30, co2_threshold=600):
    """
...
def main():
    ...
    df_with_occupancy_logic = predict_occupancy_logic(df)
    print(df_with_occupancy_logic)
    df_first_last = get_first_last(df_with_occupancy_logic)
    print(df_first_last)
